...
The sources for radiome can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/ccraddock/radiome
.. _tarball: https://github.com/ccraddock/radiome/tarball/master
